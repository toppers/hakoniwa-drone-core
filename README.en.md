...
- 📄 License (Japanese): [LICENSE-ja](LICENSE-ja.md)
...
For details, please refer to [here](/drone_api/README-ja.md).
...
*   🖼️ [View Overall Architecture](docs/architecture/overview.md)
...
📘 [View Single Pattern Tutorial](docs/getting_started/single.md)
...
📘 [View Shared Memory Pattern Tutorial](docs/getting_started/mmap.md)
...
📘 [View Container Pattern Tutorial](docs/getting_started/container.md)
