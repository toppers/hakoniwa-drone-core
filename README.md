...
WSL2 上の Docker コンテナで MuJoCo / Web bridge を動かし、Windows 側のゲームパッドを `rc-endpoint.py` で統合起動する場合は、以下を参照してください。

📘 [WSL2/Docker + Windowsゲームパッドで RC Endpoint を使う](docs/tips/wsl/docker-rc-endpoint.md)
